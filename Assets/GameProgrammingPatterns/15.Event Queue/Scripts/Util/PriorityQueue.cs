/*** 
 * @Author: NickPansh
 * @Date: 2023-03-22 08:51:36
 * @LastEditors: NickPansh
 * @LastEditTime: 2023-03-22 10:03:01
 * @FilePath: \trunk\Assets\Scripts\Framework\DataStructure\Generic\PriorityQueue.cs
 * @Description: 这个类是从.NET 6.0的源码中提取出来的，用于实现优先级队列
 * @用法参见https://learn.microsoft.com/zh-cn/dotnet/api/system.collections.generic.priorityqueue-2?view=net-7.0
 * @
...
namespace WenQu
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        {
            // commented by NickPansh:如果 TPriority 是值类型
            if (typeof(TPriority).IsValueType)
            {
                // commented by NickPansh:若用户手动指定了默认比较器，则恢复使用优化路径
            ...
            else //commented by NickPansh:如果TPriority是引用类型，由于JIT不会优化直接调用Comparer<T>.Default.Compare，所以我们需要缓存比较器实例
            {
